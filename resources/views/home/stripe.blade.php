...
<div class="container">
    ...
    <h1 style="text-align:center; font-size:24px; padding-bottom:20px;"> Payez Avec Votre Carte - Montant Total: {{$totalprice}} Fcfa</h1>
    
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                <div class="panel-heading display-table" >
                        <h3 class="panel-title" >Détails Paiement</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form 
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input type="submit" name="" value="Payez maintenant">
